...
contract CoordinatorInitiateEpochTest is CoordinatorBaseTest {
    ...
    function test_InitiateEpochReceivingExecutorsInfoUpdate() public {
        ...
        (uint256 executorBalance,,,,uint8 roundsCheckedInEpochExecutor,,,uint96 executionsInRoundsInEpochExecutor,,) = coordinator.executorInfo(executor);
        ...
        (uint256 secondExecutorBalance,,,,uint8 roundsCheckedInEpochSecondExecutor,,,uint96 executionsInRoundsInEpochSecondExecutor,,) = coordinator.executorInfo(secondExecutor);
        ...
        (uint256 thirdExecutorBalance,,,,uint8 roundsCheckedInEpochThirdExecutor,,,uint96 executionsInRoundsInEpochThirdExecutor,,) = coordinator.executorInfo(thirdExecutor);
